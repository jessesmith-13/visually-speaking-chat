...
serve(async (req) => {
  ...
  try {
    ...
    if (amount !== expectedAmount) {
      throw new Error(`Amount mismatch. Expected ${expectedAmount} cents, got ${amount} cents`);
    }
    ...
    console.log(`Created payment intent ${paymentIntent.id} for user ${user.id}, event ${eventId}`);
